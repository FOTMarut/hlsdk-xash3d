...
void HUD_PlaySound( const char *sound, float volume )
{
	...
	gEngfuncs.pfnPlaySoundByNameAtLocation( sound, volume, g_finalstate->playerstate.origin.asArray() );
}
	...
	const float *origin, const float *angles, float fparam1, float fparam2, int iparam1, int iparam2, int bparam1, int bparam2 )
{
	...
	ang			= v_angles;
	gEngfuncs.pfnPlaybackEvent( flags, pInvoker, eventindex, delay, org.asArray(), ang.asArray(), fparam1, fparam2, iparam1, iparam2, bparam1, bparam2 );
}
