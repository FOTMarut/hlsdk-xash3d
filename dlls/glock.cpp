...
void CGlock::GlockFire( float flSpread, float flCycleTime, BOOL fUseAutoAim )
{
	...
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), fUseAutoAim ? m_usFireGlock1 : m_usFireGlock2, 0.0, g_vecZero.asArray(), g_vecZero.asArray(), vecDir.x, vecDir.y, 0, 0, ( m_iClip == 0 ) ? 1 : 0, 0 );
