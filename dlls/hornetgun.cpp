...
void CHgun::PrimaryAttack()
{
	...
	flags = 0;
#endif
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usHornetFire, 0.0, g_vecZero.asArray(), g_vecZero.asArray(), 0.0, 0.0, FIREMODE_TRACK, 0, 0, 0 );
...
void CHgun::SecondaryAttack( void )
{
	...
	flags = 0;
#endif
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usHornetFire, 0.0, g_vecZero.asArray(), g_vecZero.asArray(), 0.0, 0.0, FIREMODE_FAST, 0, 0, 0 );
