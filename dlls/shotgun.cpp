...
void CShotgun::PrimaryAttack()
{
	...
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usSingleFire, 0.0, g_vecZero.asArray(), g_vecZero.asArray(), vecDir.x, vecDir.y, 0, 0, 0, 0 );
...
void CShotgun::SecondaryAttack( void )
{
	...
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usDoubleFire, 0.0, g_vecZero.asArray(), g_vecZero.asArray(), vecDir.x, vecDir.y, 0, 0, 0, 0 );
